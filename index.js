...
express()
  ...
  .get('/edit', (req, res) => {
    ...
    SoapClient.retrieve(
      'DataExtension',
      ["Description","CustomerKey","Fields","Name","SendableDataExtensionField"],
      reqoptions,
